...
export default function Navbar() {
  return (
    <nav className="flex flex-row items-center justify-between px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 h-[56px] bg-white w-full text-sm border-b border-gray-400">
      {/* Left */}
